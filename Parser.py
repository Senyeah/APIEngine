...
class RedirectEntry:
	...
	def dict_value(self):
		"""Returns a dictionary containing value of itself"""
...
class Parser:
	...
	def parse(self):
		"""Parse the tokens and return a tree containing all endpoints"""
	...
	def process_export(self, endpoint_prefix_components = None, path_prefix = None):
		...
		for endpoint in endpoints:
			...
			current[EndpointComponent.ROOT] = entry.dict_value()
